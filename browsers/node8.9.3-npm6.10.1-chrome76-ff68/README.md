# khulnasoft/browsers:node8.9.3-npm6.10.1-chrome76-ff68

A complete image with:
- all operating system dependencies for Khulnasoft
- Chrome 76 browser
- Firefox 68 browser
...
```
FROM khulnasoft/browsers:node8.9.3-npm6.10.1-chrome76-ff68
