...
WARNING: this file was autogenerated by generate-included-image.js using
    ...
    npm run add:included -- 11.1.0 khulnasoft/browsers:node16.16.0-chrome105-ff104-edge
-->

# khulnasoft/included:11.1.0
...
```shell
$ docker run -it -v $PWD:/e2e -w /e2e khulnasoft/included:11.1.0
