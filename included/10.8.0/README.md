...
WARNING: this file was autogenerated by generate-included-image.js using
    ...
    npm run add:included -- 10.8.0 khulnasoft/browsers:node16.14.2-slim-chrome100-ff99-edge
-->

# khulnasoft/included:10.8.0
...
```shell
$ docker run -it -v $PWD:/e2e -w /e2e khulnasoft/included:10.8.0
