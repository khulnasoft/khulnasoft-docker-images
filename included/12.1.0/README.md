...
WARNING: this file was autogenerated by generate-included-image.js using
    ...
    npm run add:included -- 12.1.0 khulnasoft/browsers:node16.16.0-chrome107-ff107-edge
-->

# khulnasoft/included:12.1.0
...
```shell
$ docker run -it -v $PWD:/e2e -w /e2e khulnasoft/included:12.1.0
